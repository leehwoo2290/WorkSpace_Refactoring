...
namespace App\user\getList\dto\query;
...
final class UserListQuery implements HttpQueryDto
{
    ...
    // Filter (프론트 key 그대로)
    private ?int $licenseSeq;  // licenseSeq (숫자(seq))
    ...
    public static function fromArray(array $query): self
    {
        ...
        $licenseSeq =self::getInt($query, 'licenseSeq', true);
    ...
    private static function checkAllowedKeys(array $query): void
    {
        $allowed = [
            ...
            'sortBy', 'sortDir',
            'name', 'region',
            'licenseSeq', 'department', 'position',
